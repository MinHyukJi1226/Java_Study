...
public class CommandLs extends Command{
    public CommandLs(String[] tokens, File currentDirectory) {
    ...
    private void showFileInfo(File file) {
        String str = String.format("%-20s\t %s\t %s\t %d", tokens, file.getName(), (file.isFile() ? "<File>" : "<Dir>"), file.lastModified(), file.length());
